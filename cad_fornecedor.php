...
div{
  ...
  <div style="background-color: white; border-radius: 15px; padding: 70px; position: absolute; top: 60%; left: 50%; transform: translate(-50%,-50%);">
		...
		<center><h1>Cadastrar Fornecedores</h1>
		<?php
		...
		?>
<form method="POST" action="proc_cad_fornecedor.php">
  <label>Nome do Fornecedor:</label>
  <input type="text" name="nome_for" required placeholder="Digite o nome do fornecedor" class="form-control rounded input-spacing"><br>
  
  <label>Cep:</label>
<input type="text" name="cep_for" required placeholder="Digite o Cep" class="form-control rounded input-spacing">
<br>

<label>Cnpj:</label>
<input type="text" name="cnpj_for" required placeholder="Digite o seu Cnpj" class="form-control rounded input-spacing">
<br>
