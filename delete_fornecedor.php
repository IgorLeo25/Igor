...
<html lang="pt-br">
  ...
  border-radius: 5px;
	...
	<a class="btn btn-light" href="principal.php" role="button">VOLTAR AO INÍCIO</a>
		...
		<center><h1>Deletar Fornecedor</h1>
		<?php
		...
		?>
		<form method="POST" action="proc_delete_fornecedor.php">
		<input type="hidden" name="cod_for" value="<?php echo 
		$row_fornecedor['cod_for'];?>">
		<input type="hidden" name="nome_for" value="<?php echo 
		$row_fornecedor['nome_for'];?>">
...
<h3> Essa operação é irreversivel - Deseja Excluir este fornecedor?</h3>
<button type="submit" class="btn btn-primary">Sim</button>
<a href='index_fornecedor.php?pagina=1'>
