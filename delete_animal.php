...
<html lang="pt-br">
  ...
  border-radius: 5px;
	...
	<a class="btn btn-light" href="principal.php" role="button">VOLTAR AO INÍCIO</a>
		...
		?>
		<form method="POST" action="proc_delete_animal.php">
		<input type="hidden" name="cod_an" value="<?php echo 
		$row_animal['cod_an'];?>">
		<input type="hidden" name="nome_an" value="<?php echo 
		$row_animal['nome_an'];?>">
...
<h3> Essa operação é irreversivel - Deseja Excluir o Registro desse Animal?</h3>
<button type="submit" class="btn btn-primary">Sim</button>
<a href='index_animal.php?pagina=1'><button type= "button" class="btn btn-primary">Não</button></a>
